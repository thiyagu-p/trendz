...
describe EquityHolding do
  ...
  describe :tradeable_match do
    ...
    it "should find transactions done on same day for buy transaction" do
      params = {portfolio: create(:portfolio), trading_account: create(:trading_account), stock: create(:stock)}
      sell_transaction1 = create(:sell_equity_transaction, params.merge(date: Date.parse('2/1/2012')))
      sell_transaction2 = create(:sell_equity_transaction, params.merge(date: Date.parse('1/1/2012')))
      sell_transaction3 = create(:sell_equity_transaction, params.merge(date: Date.parse('3/1/2012')))
      create(:equity_holding, equity_transaction: sell_transaction1)
      create(:equity_holding, equity_transaction: sell_transaction2)
      create(:equity_holding, equity_transaction: sell_transaction3)
      buy_transaction = create(:buy_equity_transaction, params.merge(date: Date.parse('2/1/2012')))
  ...
  describe :consolidated do
    ...
    shared_examples_for "consolidation group" do |field|
      it "should not group different #{field} together" do
        params = {portfolio: create(:portfolio), trading_account: create(:trading_account), stock: create(:stock)}
        create(:equity_holding, equity_transaction: (buy_transaction1 = create(:buy_equity_transaction, params)))
        create(:equity_holding, equity_transaction: (buy_transaction2 = create(:buy_equity_transaction, params)))
        create(:equity_holding, equity_transaction: (buy_transaction3 = create(:buy_equity_transaction, params.merge(field => create(field)))))
